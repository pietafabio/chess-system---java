...
public class ChessPosition {
	...
	protected static ChessPosition fromPosition(Position position) {	// operação inversa: de 'Position' para 'ChessPosition'
		return new ChessPosition((char)('a' - position.getColumn()), 8 - position.getRow()); // fórmula inversa
	}
	
	@Override
	public String toString() {				// imprimir a posição de xadrez na ordem: string vazio concatenado com coluna e concatenado com a linha
		return "" + column + row;
	}
}